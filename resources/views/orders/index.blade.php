    ...
    <div class="col-lg-10 col-lg-offset-1">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                                            ...
                                            <tr>
                                                ...
                                                @if($index === 0)
                                                    ...
                                                    <td rowspan="{{ count($order->items) }}" class="text-center">
                                                        @if($order->paid_at)
                                                            @if($order->refund_states === \App\Models\Order::REFUND_STATUS_PENDING)
                                                                已支付
                                                            @else
                                                    ...
                                                    <td rowspan="{{ count($order->items) }}" class="text-center"><a class="btn btn-primary btn-xs">查看订单</a></td>
                                                @endif
                                            </tr>
                                        @endforeach
                                    </table>
                ...
                <duv class="pull-right">{{ $orders->render() }}</duv>
            </div>
        </div>
    </div>
</div>
